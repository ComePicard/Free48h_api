...
from api.dao.daoticket import get_ticket_by_id, add_ticket, edit_ticket, delete_ticket
...
class CreateTicketModel(BaseModel):
    ...
    support_id: int = Field(None, description="Identifiant du support qui a prend le ticket en charge")
...
class TicketModel(CreateTicketModel):
    ticket_id: int = Field(None, description="Identifiant du ticket")
    date_creation: datetime = Field(..., description="Date de création du ticket", example=
                                    "2022-10-04T12:39:19.291694+00:00")
